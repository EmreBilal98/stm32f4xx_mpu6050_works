...
MPU6050_status mpu6050_read_byte(I2C_Handle_t *hi2c,uint8_t reg_addr,uint8_t * data){

	I2C_MasterSendData(hi2c,&reg_addr,1,MPU6050_I2C_ADDR,ENABLE);
	I2C_MasterReceiveData(hi2c,data, 1,MPU6050_I2C_ADDR,ENABLE);
...
MPU6050_status mpu6050_read(I2C_Handle_t *hi2c,uint8_t reg_addr,uint8_t * data,uint8_t len){

	I2C_MasterSendData(hi2c,&reg_addr,1,MPU6050_I2C_ADDR,ENABLE);
	I2C_MasterReceiveData(hi2c,data, len,MPU6050_I2C_ADDR,DISABLE);
...
MPU6050_status mpu6050_write_byte(I2C_Handle_t *hi2c,uint8_t reg_addr,uint8_t  data){

	uint8_t allData[2]={reg_addr,data};

	I2C_MasterSendData(hi2c,allData, 2,MPU6050_I2C_ADDR,ENABLE);
...
MPU6050_status mpu6050_init(I2C_Handle_t *hi2c){
...
MPU6050_status mpu6050_Set_LPF(I2C_Handle_t *hi2c,mpu6050_lpf_values lpf){
...
MPU6050_status mpu6050_read_accelerometer_data(I2C_Handle_t *hi2c,mpu6050_accel_data_t * accel_data){
